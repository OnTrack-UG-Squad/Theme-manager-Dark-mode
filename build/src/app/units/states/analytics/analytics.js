angular.module('doubtfire.units.states.analytics', ['doubtfire.units.states.analytics.directives']).config(["$stateProvider", function($stateProvider) {
  return $stateProvider.state('units/analytics', {
    parent: 'units/index',
    url: '/analytics',
...
}]).controller("UnitAnalyticsStateCtrl", ["$scope", function($scope) {
  $scope.tabs = {
    csvStatDownload: {
  ...
  return $scope.isActiveTab = function(tab) {
